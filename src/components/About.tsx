...
const stats = [
  { num: "50+", label: "Projects",   color: "#39ff5a" },
  { num: "5",   label: "Languages",  color: "#ff2d9b" },
...
export default function About() {
  ...
  return (
    <section id="about" ref={ref} className="relative w-full bg-black overflow-hidden">
      <div className="absolute inset-0 dot-grid pointer-events-none" />
      <div className="absolute top-0 right-0 w-[700px] h-[500px] pointer-events-none"
        style={{ background: "radial-gradient(ellipse at top right, rgba(255,45,155,0.04) 0%, transparent 65%)" }} />
      <div className="absolute bottom-0 left-0 w-[600px] h-[400px] pointer-events-none"
        style={{ background: "radial-gradient(ellipse at bottom left, rgba(57,255,90,0.04) 0%, transparent 65%)" }} />
      ...
      <div className="w-full overflow-hidden border-y border-white/[0.04] py-3 relative z-10"
        ...
        <div className="flex w-max animate-marquee-slow">
          {[...marqueeItems, ...marqueeItems].map((item, i) => (
            <span key={i} className="font-mono-custom text-[9px] tracking-[0.28em] uppercase text-white/20 mx-7 shrink-0">
              {item}
            </span>
          ))}
        </div>
      ...
      <div className="py-24 md:py-36 px-6 md:px-12 lg:px-20 relative z-10">
        <div className="max-w-[1400px] mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-28 items-start">
            ...
            >
              <p className="font-mono-custom text-[9px] tracking-[0.32em] uppercase text-white/25 mb-5">— Who I Am</p>
              <h2 className="font-display text-[clamp(3rem,7.5vw,6.5rem)] text-white uppercase leading-none mb-10">
                Designing<br />
                With<br />
                <span className="text-green">Purpose &<br />Passion</span>
              </h2>
              ...
              <div className="grid grid-cols-3 gap-3 mb-10">
                {stats.map((s) => (
                  ...
                  >
                    ...
                    <p className="font-mono-custom text-[8px] tracking-[0.22em] uppercase text-white/30">{s.label}</p>
                  </div>
                ))}
              </div>
            ...
            >
              ...
              <div className="glass p-7">
                <p className="font-mono-custom text-[8px] tracking-[0.3em] uppercase text-white/25 mb-4">About</p>
                ...
                <p className="text-white/40 text-[15px] leading-relaxed mt-4">
              ...
              <div className="glass p-6">
                <p className="font-mono-custom text-[8px] tracking-[0.3em] uppercase text-white/25 mb-4">Languages</p>
                <div className="flex flex-wrap gap-2">
                  {(["English","Kannada","Hindi","Telugu","Tamil"] as const).map((lang, i) => {
                    const c = ["#39ff5a","#ff2d9b","#ff6a00","#00e5ff","#b5f500"][i];
                    return (
              ...
              <a
                ...
                style={{ borderColor: "rgba(57,255,90,0.08)" }}
              >
                <span className="font-mono-custom text-[10px] tracking-[0.2em] uppercase text-white/50 group-hover:text-[#39ff5a] transition-colors">
                  Download Resume
                </span>
                <svg xmlns="http://www.w3.org/2000/svg" width="15" height="15" viewBox="0 0 24 24" fill="none"
                  stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"
                  className="text-white/30 group-hover:text-[#39ff5a] group-hover:translate-y-0.5 transition-all duration-200">
